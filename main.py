import No
def startthebot(token=None,startwebserverforrepl=False):
    if token == None:
        return print("Give me token")
    if startwebserverforrepl == True:
        No.keep()
        print("Server should running fine.\nThis support to repl only!")
    else:
        print("No running or port were opened :)")
